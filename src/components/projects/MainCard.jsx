          ...
          <CardContent>
            <Typography variant="body2" color="text.secondary">
              ...
              <Link
                onClick={() => {
                  window.open(
                    'https://github.com/kai-zen/food-palace-2',
                    '_blank'
                  );
                }}
                sx={{ cursor: 'pointer' }}
          ...
          <Collapse in={expanded} timeout="auto" unmountOnExit>
            <CardContent>
              ...
              <Typography paragraph>
                I used Material UI to implement components and cookies to save
                data, Redux to manage states in client side and SSR + static
                generation to fetch data from my own APIs (by axios) which are
                implemented using Next api routes. Saved data in mongo db and
                did the CRUD on it using mongoose.
              </Typography>
              <Typography paragraph>React.js version:</Typography>
              <Typography paragraph>
                In React version, I used react-router v6 to manage routes and
                Formik to validate forms, Redux to manage data and
              </Typography>
              <Box>
